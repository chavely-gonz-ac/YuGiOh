...
namespace YuGiOh.Infrastructure.Migrations
{
    ...
    [Migration("20251115103919_AddingRoundAndMatchEntities")]
    partial class AddingRoundAndMatchEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YuGiOh.Domain.Models.Match", b =>
                {
                    ...
                    b.Property<int>("BlackPlayerResult")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<int>("WhitePlayerResult")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("YuGiOh.Domain.Models.Round", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YuGiOh.Domain.Models.Match", b =>
                {
                    b.HasOne("YuGiOh.Domain.Models.Player", "BlackPlayer")
                        .WithMany()
                    ...
                    b.HasOne("YuGiOh.Domain.Models.Player", null)
                        .WithMany("Matches")
                        .HasForeignKey("PlayerId");

                    b.HasOne("YuGiOh.Domain.Models.Round", "Round")
                        .WithMany("Matches")
                    ...
                    b.HasOne("YuGiOh.Domain.Models.Player", "WhitePlayer")
                        .WithMany()
